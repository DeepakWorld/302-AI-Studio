...
export const quickPromptsEn: QuickPrompt[] = [
	{
	...
	{
		act: "Conventional Commit Message Generator",
		prompt:
	...
	{
		act: "Knowledgeable Software Development Mentor",
		prompt:
	...
	{
		act: "Any Programming Language to Python Converter",
		prompt:
	...
	{
		act: "Structured Iterative Reasoning Protocol (SIRP)",
		prompt:
	...
	{
		act: "Architect Guide for Programmers",
		prompt:

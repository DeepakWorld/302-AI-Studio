...
export interface AutoGeneratedIpcServices {
	...
	codeAgentService: {
		...
		addClaudeCodeSandboxMCP(sandboxId: string, mcpServerUrls: string[]): Promise<{ isOK: boolean }>;
	};
	ghostWindowService: {
...
export const autoGeneratedServices: AutoGeneratedIpcServices = {
	...
	codeAgentService: {
		...
		addClaudeCodeSandboxMCP: (sandboxId: string, mcpServerUrls: string[]) =>
			ipcRenderer.invoke("codeAgentService:addClaudeCodeSandboxMCP", sandboxId, mcpServerUrls),
	},
	ghostWindowService: {

...
export interface AutoGeneratedIpcServices {
	...
	envService: {
		...
		validPodmanPrecondition(): Promise<{ isOk: boolean; isValid: boolean; message?: string }>;
		checkPodmanHealth(): Promise<{ isOk: boolean; isHealth: boolean }>;
	};
	externalLinkService: {
...
export const autoGeneratedServices: AutoGeneratedIpcServices = {
	...
	envService: {
		...
		validPodmanPrecondition: () => ipcRenderer.invoke("envService:validPodmanPrecondition"),
		checkPodmanHealth: () => ipcRenderer.invoke("envService:checkPodmanHealth"),
	},
	externalLinkService: {

...
export interface AutoGeneratedIpcServices {
	...
	envService: {
		...
		validPodman(): Promise<{ isOk: boolean; isValid: boolean; output?: string; error?: string }>;
...
export const autoGeneratedServices: AutoGeneratedIpcServices = {
	...
	envService: {
		getComposeDirectory: () => ipcRenderer.invoke("envService:getComposeDirectory"),
		openComposeDirectory: () => ipcRenderer.invoke("envService:openComposeDirectory"),
		getLocalBaseUrl: () => ipcRenderer.invoke("envService:getLocalBaseUrl"),
		getSandboxStatus: () => ipcRenderer.invoke("envService:getSandboxStatus"),
		validPodman: () => ipcRenderer.invoke("envService:validPodman"),
		startPodmanHealthCheck: () => ipcRenderer.invoke("envService:startPodmanHealthCheck"),
		installWSL: () => ipcRenderer.invoke("envService:installWSL"),
		installScoop: () => ipcRenderer.invoke("envService:installScoop"),
		installHomebrew: () => ipcRenderer.invoke("envService:installHomebrew"),
		installPodman: () => ipcRenderer.invoke("envService:installPodman"),
		stopLocalSandboxByIpc: () => ipcRenderer.invoke("envService:stopLocalSandboxByIpc"),
		ensureLocalSandboxRunning: () => ipcRenderer.invoke("envService:ensureLocalSandboxRunning"),
		startPodmanMachine: () => ipcRenderer.invoke("envService:startPodmanMachine"),
	},
	codeAgentService: {
		...
		addClaudeCodeSandboxMCP: (sandboxId: string, MCPInfos: { url: string; name: string }[]) =>
			ipcRenderer.invoke("codeAgentService:addClaudeCodeSandboxMCP", sandboxId, MCPInfos),
		createThreadForSession: (
			threadId: string,
			sandboxId: string,
			sessionId: string,
...
export interface ElectronAPIExtension {
	...
	envService: AutoGeneratedIpcServices["envService"];
